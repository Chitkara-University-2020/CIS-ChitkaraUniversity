...
<form action="scripts/add-testimonial.php" method="POST">
<div class="row">
<h2><span style="color: #8bcdcd;">T</span>estimonial <span style="color: #8bcdcd;">B</span>y <span style="color: #8bcdcd;">P</span>atient</h2>
</div><br><br>
<div class="row">
<div class="col-sm-4 text-left">
<b>
...
<div class="row text-center">
<button type="submit" class="btn btn-info btn-lg">Add Testimonial</button>
</div><br><br>
</form>
<form action="scripts/add-social-links.php" method="POST">
<div class="row">
<h2><span style="color: #8bcdcd;">S</span>ocial <span style="color: #8bcdcd;">L</span>inks</h2>
</div><br><br>
<div class="row">
<div class="col-sm-4 text-left">
<b>
...
<label><?php $social_links=json_decode($result_array['info']); if($result_array->tagline!="null"){echo $result_array->tagline;} else{ echo "Tagline";}?></label>
</div>
</div>
</div>
</div><br><br>
...
<div class="row text-center">
<button type="submit" class="btn btn-info btn-lg">Add Links</button>
</div><br><br>
</form>
